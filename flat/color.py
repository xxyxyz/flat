...
class gray(object):
    ...
    def __ne__(self, other):
        return not isinstance(other, gray) or self.intensity != other.intensity
...
class ga(object):
    ...
    def __ne__(self, other):
        return not isinstance(other, ga) or self.g != other.g or self.a != other.a
...
class rgb(object):
    ...
    def svg(self):
        return "rgb(%s,%s,%s)" % (dump(self.r), dump(self.g), dump(self.b))
...
class spot(object):
    ...
    def __ne__(self, other):
        return (
            not isinstance(other, spot)
            or self.name != other.name
            or self.tint != other.tint
        )
...
class overprint(object):
    ...
    def __ne__(self, other):
        return not isinstance(other, overprint) or self.color != other.color
