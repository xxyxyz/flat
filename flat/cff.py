...
class cff(object):
    def __init__(self, readable):
        ...
        self.localsubr = (
            self.index(offset + privatedict[19][0]) if 19 in privatedict else []
        )  # Subrs
        ...
        while r.position < end:
            ...
            if value <= 31:
                if value in (
                    ...
                    20,
                    23,
                ):  # hstem, vstem, hstemhm, hintmask, cntrmask, vstemhm
                    hints += len(stack) // 2
                    if value == 19 or value == 20:
                        r.skip((hints + 7) // 8)
                    stack.clear()
                elif (
                    value == 4 or value == 21 or value == 22
                    ...
                    if value == 34:  # hflex
                        ...
                        29,
                        30,
                    ):  # aritmetic, storage, conditional operators
